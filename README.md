this is a fork of the real project are [GITHUB](https://github.com/gmag11/MetaTrader5-Docker-Image) all thanks are on this developer, i only recrate for work with MetaTrader4
